...
def menu_puszcza_reymlandzka(gracz):
    while True:
        ...
        def losowa_lokacja():
            lokalizacje = {
                "Bagno Kwiecistych Trzcin": 20,
                "Bagno Spiewajacych Zab": 20,
                "Bagno Dlugie Cienie": 20,
                "Cmentarz Malowniczych Kamieni": 15,
                "Cmentarz Swietych Dusz": 15,
                "Dolina Mistycznego Czasu": 15,
                "Las Szeptow Natury": 15,
                "Jaskinia Lsniacych Skarbow": 10,
                "Staw laskoczacych Roz": 10,
                "Staw Dloniecia Zorzy": 10,
                "Wioska Zapomnianych Dusz": 10,
                "Wyspa Mgiel i Marzen": 10
            }
        ...
        table_info = Table(title="Puszcza Reymlandzka", show_header=False, header_style="bold magenta")
        ...
        console.print(Panel.fit(table_info, title="Puszcza Reymlandzka", border_style="bold magenta"))
