    ...
    while True:
        ...
        def losowa_lokacja():
            lokalizacje = {
                ...
                "Cmentarz Wiecznych Swiatel": 20,
                "Dolina Mrocznych Tajemnic": 20,
                "Grobowiec Zagubionych Dusz": 15,
                "Jama Malowanych Ciemnosci": 15,
                "Jaskinia Zakletych Marzen": 15,
                "Opuszczona Kopalnia Mroku": 10,
                "Strumyk Zaginionych Nadziei": 10,
                "Rezydencja Zlowrogich Duchow": 10,
                "Grota Nocy": 10
            }
        ...
        table_info = Table(title="Thriller Bark", show_header=False, header_style="bold magenta")
        ...
        console.print(Panel.fit(table_info, title="Thriller Bark", border_style="bold magenta"))
